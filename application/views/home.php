<?= $header ?>
    ...
    <div class="w-container">
      ...
      <div class="w-clearfix cta"><a href="#" class="w-button sbutton">Candidates</a><a href="#" class="w-button fbutton">Job Opportunities</a>
      </div>
    </div>
  </div>
    ...
    <div class="w-container">
      <div class="w-row">
        <div class="w-col w-col-6">
          <h2 class="homeheader2">Why it is good for business ?</h2>
          <p class="firsttext">Despite the cost involved in accomodating a disabled person in your company, &nbsp;A diverse workforce gives you a competitive advantage by adding new ideas, viewpoints and approaches to solving your business challenges.
            <br>
