				...
				<div class="w-row">
					<div class="w-col w-col-6">
						...
						<div class="social-icon-group">
							<a href="#" class="w-inline-block social-icon"><img src="public/images/facebook-icon.svg">
							</a>
							<a href="#" class="w-inline-block social-icon"><img src="public/images/twitter-icon.svg">
							</a>
							<a href="#" class="w-inline-block social-icon"><img src="public/images/linkdin-icon-white.svg">
							</a>
							<a href="#" class="w-inline-block social-icon"><img src="public/images/email-icon-white.svg">
							</a>
						</div>
					</div>
					...
					<div class="w-col w-col-2">
						<h4 class="footer-title">Resources</h4><a href="#" class="page-link in-footer">Blog</a><a href="#" class="page-link in-footer">Employer Guide</a>
					</div>
					<div class="w-col w-col-2">
